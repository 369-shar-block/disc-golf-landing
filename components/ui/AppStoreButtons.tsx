...
export function AppStoreButtons({
  ...
  // Link to waitlist page for launch announcement
  const iosLink = '/waitlist';

  return (
    <div className={containerClasses}>
      {/* iOS Button with Launch Date */}
      <motion.a
        href={iosLink}
      ...
      >
        ...
        <div className="text-left relative z-10">
          <div className="text-xs text-text-secondary font-medium">Launching on</div>
      ...
      >
        <span className="inline-flex items-center gap-1 px-3 py-1 bg-gradient-action rounded-full text-white font-semibold text-xs shadow-action-glow">
